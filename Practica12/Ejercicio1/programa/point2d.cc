...
float point2d::Distance(point2d& punto2){
  return sqrt((this->get_coordenadaX() - punto2.get_coordenadaX()) * (this->get_coordenadaX() - punto2.get_coordenadaX())
  + 
  (this->get_coordenadaY() - punto2.get_coordenadaY()) * (this->get_coordenadaY() - punto2.get_coordenadaY()));
}

point2d point2d::Middle(point2d& punto2){
	point2d puntomedio;
	puntomedio.set_coordenadaX(this->get_coordenadaX() + ((punto2.get_coordenadaX() - this->get_coordenadaX()) / 2));
	puntomedio.set_coordenadaY(this->get_coordenadaY() + ((punto2.get_coordenadaY() - this->get_coordenadaX()) / 2));
